# -*- coding: utf-8 -*-
#
# File name     : SortedList.py
#

'''
SortedList - Provide a list whose elements inside had been sorted.
...
class SortedList:
    ...
    def __setitem__(self, index, value):
        raise TypeError("use add() to insert a value, and rely on "
                        "the list to put it in the right position")
    ...
    def copy(self):
        return SortedList(self, self.__list)
